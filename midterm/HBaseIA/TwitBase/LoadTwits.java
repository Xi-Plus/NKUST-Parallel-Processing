...
public class LoadTwits {
  ...
  public static final String usage = "loadtwits count\n" + "  help - print this message and exit.\n"
  ...
  private static DateTime randDT() {
    ...
    // Construct an instance from datetime field values
    // year - the year; monthOfYear - the month of the year, from 1 to 12;
    // dayOfMonth - the day of the month, from 1 to 31
    // hourOfDay - the hour of the day, from 0 to 23; minuteOfHour - the minute of
    // the hour, from 0 to 59
    // secondOfMinute - the second of the minute, from 0 to 59; millisOfSecond - the
  ...
  public static void main(String[] args) throws IOException {
    ...
    // add HBase configuration files to a org.apache.hadoop.conf.Configuration
    Configuration conf = HBaseConfiguration.create();
    // provide an interface to manage HBase database
    // Class HBaseAdmin is no longer a client API
    HBaseAdmin admin = new HBaseAdmin(conf);

    if (!admin.tableExists(UsersDAO.TABLE_NAME) || !admin.tableExists(TwitsDAO.TABLE_NAME)) {
      System.out.println("Please use the InitTables utility to create " + "destination tables first.");
      System.exit(0);
    }
